...
$\theta_{\rm FWHM}=1'$ or $4'$. Here, $f_{\rm sky}$ is set to one. \scott{Peikai, can you check fsky and lmax?} \wh{labels on figs need to be bigger, factors of $\ell$ need to be explained}}
