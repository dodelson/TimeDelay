...
%=======
 ...
 \bea
 \langle \hat{d}^{\rm mv}_{LM} \rangle &\equiv& d_{LM} +\phi_{LM}E_{L}^{\rm mv}\sqrt{\frac{C_L^{dd}}{C_L^{\phi\phi}}}, \nonumber\\
 \langle \hat{\phi}^{\rm mv}_{LM} \rangle &\equiv& \phi_{LM} +d_{LM}F_{L}^{\rm mv}\sqrt{\frac{C_L^{\phi\phi}}{C_L^{dd}}},
\eea
