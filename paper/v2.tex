...
$\phi$ and $d$ individually, we show this quantity in Fig.~\rf{CrossStoN} where we have set
 $f_{\rm sky}=1$. We  see that in this ideal case, $S/N$ could reach about $2.5$.  \wh{Although
 there are many other lens, and more generally large-scale structure tracers, that delay 
 reconstruction can be correlated with, note that the $S/N$ is dominated by $N_L^d$ not
