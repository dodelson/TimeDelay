...
\eea
\wh{why interchange the rolls of $L \leftrightarrow l'$ for $d$? are you trying to get rid of some $(-1)^{l+l'+L}$ phase 
factor for $s\ne 0$?  relatedly $s$ looks unexplained here.}
with
\bea
...
\Spng{StoN}{Time Delay Signal to Noise for $L=1$,$l_{\rm min}$ fixed at $1000$, $l_{\rm max}$ varying}
