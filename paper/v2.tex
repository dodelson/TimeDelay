...
\eea
Notice that we can choose the definition of $\bar{h}$ to minimize $\mathcal{N}$, and our choice is
\bea 
\bar{h}_{l_{1}l_{2}}^{\alpha,\phi}(L) = \bar{h}_{l_{1}l_{2}}^{\alpha,d}(L)= h_{l_{1}l_{2}}^{\alpha,\phi} (L)
\eea 
with 
\bea 
\bar{A}_{L}^{\alpha} &=& L(L+1)(2L+1)\left\{ \sum_{l_{1}l_{2}}\bar{h}_{l_{1}l_{2}}^{\alpha,\phi}(L)f_{l_{1}Ll_{2}}^{\alpha} \right\}^{-1} \nonumber \\
&=& L(L+1)(2L+1)\left\{ \sum_{l_{1}l_{2}}h_{l_{1}l_{2}}^{\alpha,\phi}(L)f_{l_{1}Ll_{2}}^{\alpha} \right\}^{-1} \\
...
In this case
\bea
\mathcal{N}_{L}^{\alpha \alpha} &=& \sqrt{L(L+1)}\bar{B}_{L}^{\alpha} \nonumber \\
&=& \sqrt{L(L+1)}(2L+1)\left\{ \sum_{l_{1}l_{2}}h_{l_{1}l_{2}}^{\alpha,\phi}(L)g_{l_{1}Ll_{2}}^{\alpha} \right\}^{-1}
\eea
\peikai{I haven't actually figure out a way to minimize $\mathcal{N}$, my choice of $\bar{h}$ would just give a very simple form of $mathcal{N}$; another thing to notice that here the definition of $A$ is the same as Okamoto \& Hu. But it is easy to get the scale Scott suggested.}
