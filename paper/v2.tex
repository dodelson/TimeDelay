...
\ee
where $K_\fd(z) = (H(z)D_*)^{-1}$ and $D_* =  \int_0^\infty e^{-\tau(z') }dz'/H(z')$.}
...
\be
K_\phi(z) \approx K(z)  \frac{D(z)-D_*}{ D(z) } .
\ee}
...
.\ee
\wh{I'm unclear on what caveat you are pointing out here - at the level, we're just linearizing and haven't yet
