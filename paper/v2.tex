...
\Sfig{kernel}{Kernel that weights the integral of the gravitational potential for the time delay examined here and the more carefully studied deflection angle. \wh{A plot here of 
$C_l^{\phi\phi}$, $C_l^{\phi d}$ and $C_l^{dd}$ would help}}
...
\wh{ Up until this point, we have assumed that the estimators of $\phi$ and $d$ are not 
...
and finally
 also define the
converse contamination and discuss whether lensing estimators ever need worry about this
effect.}
...
\ee
And contamination from lensing is relatively large, $E_{L=1}^{TT} \approx -1.73$.}
